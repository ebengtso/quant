    ...
    new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc)
        ...
        public static void SendMail(QCAlgorithm algorithm, string AlgorithmId, string title, string body, string url, string id)
        {
            ...
            try
            {
                ...
                client.Credentials = new System.Net.NetworkCredential("ebengtso@gmail.com", "Q8x-oNE-oac-XUy");

                MailMessage mm = new MailMessage("ebengtso@gmail.com", "ebengtso@gmail.com", string.Format("{0}-{1} {2}", AlgorithmId, Identifier,title), body);
        ...
        private static string SlackURL = "https://hooks.slack.com/services/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";
